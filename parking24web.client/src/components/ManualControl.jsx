...
const ManualControl = ({ isPLCConnected, isAuthenticated, sendCommand }) => {
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-bold mb-4 text-gray-800">수동 제어</h2>
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-2">
                            <div className={`w-3 h-3 rounded-full ${isAuthenticated ? 'bg-green-400' : 'bg-yellow-400'}`}></div>
                            <span>인증 {isAuthenticated ? '완료' : '대기'}</span>
                        </div>
                    </div>
                    {isDisabled && (
                        <span className="text-red-500 font-medium">제어 불가</span>
                    )}
                </div>
            </div>
            ...
            {/* 승강 제어 */}
            <div className="mb-6">
                <h3 className="text-lg font-semibold mb-3 text-gray-700">승강 제어</h3>
                <div className="grid grid-cols-2 gap-4">
                    <button
                        ...
                        disabled={isDisabled}
                        className={`relative p-6 rounded-lg font-semibold text-white transition-all duration-200 ${isDisabled
                    ...
                    >
                        <div className="flex flex-col items-center space-y-2">
                            ...
                            <span className="text-lg">상승</span>
                        </div>
                        {activeCommand === 'liftUp' && (
                            <div className="absolute inset-0 bg-blue-300 rounded-lg animate-pulse"></div>
                        )}
                    </button>
                    ...
                    >
                        <div className="flex flex-col items-center space-y-2">
                            ...
                            <span className="text-lg">하강</span>
                        </div>
                        {activeCommand === 'liftDown' && (
                            <div className="absolute inset-0 bg-green-300 rounded-lg animate-pulse"></div>
                        )}
                    </button>
                </div>
            </div>
            ...
            {/* 횡행 제어 */}
            <div className="mb-6">
                <h3 className="text-lg font-semibold mb-3 text-gray-700">횡행 제어</h3>
                <div className="grid grid-cols-2 gap-4">
                    <button
                    ...
                    >
                        <div className="flex flex-col items-center space-y-2">
                            ...
                            <span className="text-lg">좌행</span>
                        </div>
                        {activeCommand === 'moveLeft' && (
                            <div className="absolute inset-0 bg-purple-300 rounded-lg animate-pulse"></div>
                        )}
                    </button>
                    ...
                    >
                        <div className="flex flex-col items-center space-y-2">
                            ...
                            <span className="text-lg">우행</span>
                        </div>
                        {activeCommand === 'moveRight' && (
                            <div className="absolute inset-0 bg-orange-300 rounded-lg animate-pulse"></div>
                        )}
                    </button>
                </div>
            </div>
            ...
            <div className="border-t pt-6">
                <button
                    ...
                    className={`w-full p-6 rounded-lg font-bold text-white text-xl transition-all duration-200 ${!isPLCConnected
                        ? 'bg-gray-400 cursor-not-allowed'
                        : isEmergencyMode
                ...
                >
                    <div className="flex flex-col items-center space-y-2">
                        ...
                        <span>비상정지</span>
                        {isEmergencyMode && <span className="text-sm">실행 중...</span>}
                    </div>
                </button>
            </div>
