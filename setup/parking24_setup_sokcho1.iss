...
[Files]
; 전체 publish 폴더 복사 (속초 1호기용 publish 폴더)
...
Name: "{autoprograms}\Parking24 웹 열기 (속초1)"; Filename: "http://localhost:5123"; IconFilename: "{sys}\shell32.dll"; IconIndex: 106
...
Name: "{autodesktop}\Parking24 웹 열기 (속초1)"; Filename: "http://localhost:5123"; Tasks: desktopicon; IconFilename: "{sys}\shell32.dll"; IconIndex: 106
...
Filename: "http://localhost:5123"; Description: "Parking24 웹 열어보기"; Flags: nowait postinstall skipifsilent shellexec
